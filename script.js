...
function cursorAnimation() {
  function initMouseFollower() {
    ...
    if (window.innerWidth < 600) {
      cursor.style.display = "none"; // Hide the cursor on small screens
    } else {
      Shery.mouseFollower({
        skew: true,
      ...
      cursor.style.display = "block"; // Show the cursor on larger screens
    }
  }
